...
\begin{itemize}
\item Analise e desenvolvimento de adaptações para operadoras na plataforma Android.
\item Desenvolvimento de testes automatizados para a plataforma Android. 
\end{itemize}

{\addtolength{\leftskip}{3.5mm}\subsection*{CPQi (Janeiro/2009 - Fevereiro/2012)}
\begin{itemize}
