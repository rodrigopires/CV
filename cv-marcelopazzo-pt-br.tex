...
\usepackage[
  ...
  left=0.75in,
  top=0.85in,
  bottom=0.8in]{geometry}            % See geometry.pdf to learn the layout options. There are lots.
...
\begin{itemize}
  ...
  \item Experiência em testes usando guard, spork e rspec
...
\subsection*{CPQi (Janeiro/2009 - Fevereiro/2012)}
\begin{itemize}
